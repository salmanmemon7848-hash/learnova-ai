...
type Phase2Response = {
  ...
  careerId: string;
  hero?: unknown;
  counselorTake?: unknown;
  salaryMap?: unknown;
  demandData?: unknown;
  educationPath?: unknown;
  skillsRequired?: unknown;
  careerRoadmap?: unknown;
  scholarships?: unknown;
  govtSchemes?: unknown;
  honestChallenges?: unknown;
  alternateIfNotPossible?: unknown;
  personalizedClosing?: unknown;
};

type AnyResponse = Phase1Response | Phase2Response | { mode?: string; careers?: unknown[]; streamOptions?: unknown[]; personalizedMessage?: string };
...
Phase: ${phase}${careerId ? `\nCareer requested: ${careerId}` : ''}`;
    ...
    if (phase === 'career_detail') {
      const p2 = data as Phase2Response;
    ...
    const p1 = data as Phase1Response;
