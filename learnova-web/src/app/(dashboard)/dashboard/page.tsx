          ...
          <div style={{ background: '#13151e', border: '1px solid #2a2d3a', borderRadius: 12, padding: '20px 24px', marginBottom: 24 }}>
            ...
            {data.recentActivity.length === 0 ? (
              <div style={{ textAlign: 'center', padding: '40px 0', color: '#6b7280' }}>
                ...
                <p style={{ marginTop: 8, fontSize: 13 }}>No activity yet — start learning to see your history here!</p>
              </div>
            ) : (
              <div>
            ...
            {activeTab === 'files' && (
              <div>
                {data.savedFiles.length === 0 ? (
                  <EmptyState emoji="📄" message="No saved files yet — generate a study plan, essay, or pitch deck!" />
                ) : (
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
