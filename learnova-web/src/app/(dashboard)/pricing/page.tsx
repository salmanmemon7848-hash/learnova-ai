  ...
  const plans = [
    {
      ...
      features: [
        ...
        { text: '3 writes/month', included: true },
        { text: 'Basic 7-day planner', included: true },
    ...
    },
    {
      ...
      features: [
        ...
        { text: '15 writes/month', included: true },
        { text: 'Full personalized planner', included: true },
    ...
    },
    {
      ...
      features: [
        ...
        { text: 'Unlimited writes', included: true },
        ...
        { text: 'Advanced planner (auto-adjusts)', included: true },
    ...
    },
    {
      ...
      features: [
        ...
        { text: 'Unlimited writes (all types)', included: true },
