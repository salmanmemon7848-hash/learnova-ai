      ...
      <div className="max-w-3xl mx-auto px-4 py-16">
        ...
        <div className="space-y-10" style={{ color: 'var(--foreground-secondary)' }}>
          ...
          <section>
            ...
            <p className="mb-3">
              By accessing or using Thinkior AI (&quot;the Service,&quot; &quot;Thinkior,&quot; &quot;we,&quot; &quot;our,&quot; or &quot;us&quot;), you agree to be bound by these Terms of Service and our Privacy Policy. If you do not agree to these terms, please do not use the Service. Your continued use of Thinkior constitutes your acceptance of these terms.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you and the individual developer operating Thinkior AI, located in Gariyaband, Chhattisgarh, India.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-bold mb-4 font-heading" style={{ color: 'var(--foreground)' }}>
              2. What Thinkior AI Is
            </h2>
            <p className="mb-3">
              Thinkior AI is an AI-powered educational and business intelligence platform built exclusively for Indian students and entrepreneurs. The Service includes:
            </p>
          ...
          <section>
            ...
            <p className="mb-3">You must be at least 13 years of age to use Thinkior AI.</p>
            <p className="mb-3">
            ...
            <p>
              ...
              <a href="mailto:thinkior.ai@gmail.com" className="hover:underline" style={{ color: 'var(--accent)' }}>thinkior.ai@gmail.com</a>.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-4 mb-3">
              Thinkior uses third-party artificial intelligence models to generate responses, study plans, business analyses, interview questions, career guidance, and other content. You acknowledge and agree that:
            </p>
            <ul className="list-disc ml-6 mb-4 space-y-1">
              ...
              <li>Content generated by Thinkior AI is not a substitute for professional legal, financial, medical, academic, or career advice</li>
          ...
          <section>
            ...
            <p className="mb-3">
              <strong>Your content:</strong> Content you create using Thinkior — including study plans, business analyses, generated documents, and saved files — belongs to you. You grant us a limited, non-exclusive, royalty-free license to process and store this content solely to provide the Service to you.
            </p>
            <p className="mb-3"><strong>Our content:</strong> The following are protected intellectual property of Thinkior AI and may not be reproduced, copied, or distributed without written permission:</p>
            <ul className="list-disc ml-6 space-y-2">
              <li>Thinkior&apos;s codebase, algorithms, AI prompt systems, and technical infrastructure</li>
              <li>Thinkior&apos;s branding, name, logo, design, and visual identity</li>
          ...
          <section>
            ...
            <ul className="list-disc ml-6 mb-4 space-y-1">
              <li>Thinkior AI and its developer make no warranties, express or implied, regarding the Service&apos;s accuracy, reliability, availability, or fitness for any particular purpose</li>
          ...
          <section>
            ...
            <p className="mb-3">You agree to indemnify, defend, and hold harmless Thinkior AI and its developer from and against any claims, damages, losses, liabilities, costs, and expenses (including reasonable legal fees) arising from:</p>
            <ul className="list-disc ml-6 space-y-1">
          ...
          <section>
            ...
            <p>
              The Service integrates with third-party services including but not limited to Groq API, Google AI (Gemini), Supabase, Vercel, and SearXNG. These services have their own terms of service and privacy policies. Your use of these services through Thinkior is subject to their respective terms. We are not responsible for the availability, accuracy, or content of third-party services.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              These Terms, together with our Privacy Policy, constitute the entire agreement between you and Thinkior AI regarding the Service and supersede all prior agreements, representations, and understandings.
            </p>
          </section>
