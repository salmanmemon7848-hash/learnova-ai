...
const file = path.join(__dirname, 'src', 'app', 'api', 'interview', 'route.ts');
let content = fs.readFileSync(file, 'utf8');

const startStr = "      const systemPrompts: Record<string, string> = {";
const endStr = "      // CORRECT: always use normalizedLang, never raw language value";
...
const newPrompts = `      const systemPrompts: Record<string, string> = {
...
fs.writeFileSync(file, beforeBlock + newPrompts + afterBlock, 'utf8');
console.log("SUCCESS: Fixed system prompts with Node.js");
